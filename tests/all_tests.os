...
ПутьКХранилищу1 = ОбъединитьПути(ТекущийКаталог, "fixtures", "storage1");
ПутьКХранилищу2 = ОбъединитьПути(ТекущийКаталог, "fixtures", "storage2");
ПутьКВыгрузкеКонфигурации = ОбъединитьПути(ТекущийКаталог, "fixtures", "src");